...
public class SeatController {
    ...
    public ResponseEntity<List<SeatStatusDto>> getAllSeatsStatus(@PathVariable Long performId) {
    ...
    public ResponseEntity<String> trySelectSeat(@PathVariable Long seatId) {
